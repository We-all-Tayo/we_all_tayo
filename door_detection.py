...
#         and MAX_X > d["x"] > RIGHT_X:
    ...
    # print(temp)
    print((prob_door['x'], prob_door["y"]), (prob_door['x']+prob_door['w'], prob_door['y']+prob_door['h']))

    temp_result = np.zeros((height, width, channel), dtype=np.uint8)
    cv2.rectangle(temp_result, pt1=(prob_door['x'], prob_door['y']), pt2=(prob_door['x']+prob_door['w'], prob_door['y']+prob_door['h']), color=(255, 255, 255), thickness=2)

    cv2.rectangle(img_ori, pt1=(prob_door['x'], prob_door['y']), pt2=(prob_door['x']+prob_door['w'], prob_door['y']+prob_door['h']), color=(255, 255, 255), thickness=2)
