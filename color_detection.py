...
def detect_color(image_path):
    ...
    red_area = calculate_area(red_mask, image)
    green_area = calculate_area(green_mask, image)
    blue_area = calculate_area(blue_mask, image)
    yellow_area = calculate_area(yellow_mask, image)
